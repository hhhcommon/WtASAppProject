...
public class SQLiteHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS playerhistory(_id Integer primary key autoincrement, "
				...
				"playeraddtime varchar(50),bjuserid varchar(50),playshareurl varchar(100),playfavorite varchar(100),contentid varchar(50),localurl varchar(100),sequname varchar(50),sequimg varchar(200),sequdesc varchar(150),sequid varchar(50))");
		...
		db.execSQL("create table IF NOT EXISTS fileinfo(_id integer primary key autoincrement,"
				...
				"playeralltime varchar(50),playerfrom varchar(50),playcount varchar(50),contentdescn varchar(100))");
